/**
 * Same as version 2, but in this case, only a subset of the remaining numbers is analyzed.
 * The processing ends, when there is a risk of TLE. Then, the remaining numbers are chosen
...
int main(void) {
    ...
    while (true) {
        ...
        if (clock() - startTime > 0.8 * CLOCKS_PER_SEC) break;
    }
