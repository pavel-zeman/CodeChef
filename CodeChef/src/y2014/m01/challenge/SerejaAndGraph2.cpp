// Finds maximum matching using Edmonds blossom algorithm (http://pastebin.com/NQwxv32y) - if it's size is half the number of vertices, then it is possible to delete the edges
...
int readGraph(){
     int n,e,a,b;
     n = getInt();
     e = getInt();      //The graph is read and its edges are unmatched by default.
